# Модуль навигации всех реестров модуля коммуникатор
...
- Зависимости модуля описаны в [CommunicatorNavigationDependency] (communicator_navigation/src/main/java/ru/tensor/sbis/communicator/communicator_navigation/contract/CommunicatorNavigationDependency.kt)
...
...
## 2. Использование.
Для доступа к функционалу модуля извне следует использовать интерфейсы, указанные в `CommunicatorNavigationFeature`

Для доступа к реализации (`CommunicatorNavigationFacade`) интерфейсов модуля следует определить их как зависимости в вызывающем модуле, а на уровне приложения иметь экземпляр такой реализации.
