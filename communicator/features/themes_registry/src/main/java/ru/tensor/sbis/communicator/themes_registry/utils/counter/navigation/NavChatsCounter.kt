...
/**
 * Счётчик непрочитанных сообщений в чатах для компонентов навигации
 * @param provider поставщик данных о количестве непрочитанных сообщений
 *
 * @author vv.chekurda
 */
internal class NavChatsCounter(provider: CounterProvider<CommunicatorCounterModel>) : NavigationCounter {

    override val newCounter: Observable<Int> = provider.counterEventObservable.map { it.unreadChats }
