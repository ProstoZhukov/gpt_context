...
/**
 * Счётчик непрочитанных сообщений в диалогах для компонентов навигации
 * @param provider поставщик данных о количестве непрочитанных сообщений
 *
 * @author vv.chekurda
 */
internal class NavDialogsCounter(provider: CounterProvider<CommunicatorCounterModel>) : NavigationCounter {

    override val newCounter: Observable<Int> = provider.counterEventObservable.map { it.unreadDialogs }
