...
/**
 * Роутер для навигации реестра сообщений
 *
 * @author da.zhukov
 */
interface CommunicatorConversationRouter :
     ...
     */
    fun showConversationDetailsScreen(params: ConversationDetailsParams)
    ...
    /**
     * Поставщик роутера [CommunicatorConversationRouter]
     */
    interface Provider : Feature {

        /** @SelfDocumented */
        fun getCommunicatorConversationRouter(): CommunicatorConversationRouter
    }
}