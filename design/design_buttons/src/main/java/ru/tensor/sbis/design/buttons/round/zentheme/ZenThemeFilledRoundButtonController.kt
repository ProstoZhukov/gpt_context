...
/**
 * Контроллер Дзен темизации [круглых кнопок][SbisRoundButton] с [заливкой][SbisRoundButtonType.Filled].
 *
 * @author ra.geraskin
 */
internal class ZenThemeFilledRoundButtonController : ZenThemeAbstractButtonController() {
