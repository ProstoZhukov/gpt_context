...
class TextLayoutMaxHeightTest {
    ...
    fun setUp() {
        ...
        textHeight = textLayout.stateSnapshot.layout!!.height
    }
    ...
    @Test
    fun `When TextLayout maxHeight is smaller than text height, then height is smaller or equals maxHeight`() {
    ...
    @Test
    fun `When TextLayout maxHeight is bigger than text height, then height is equals text height`() {
        val maxHeight = textHeight * 2
    ...
    @Test
    fun `When TextLayout maxHeight is smaller than multiline text height, then lineCount is equals max of availableLines`() {
        val segmentation = 2
    ...
    @Test
    fun `When TextLayout maxHeight is smaller than sum of padding and text height, then height is smaller or equals maxHeight`() {
    ...
    @Test
    fun `When TextLayout maxHeight is bigger than sum of padding and text height, then height is equals sum of padding and text height`() {
        val layoutPadding = TextLayoutPadding(top = 100)
        val textHeightWithPadding = textHeight + layoutPadding.top
        val maxHeight = textHeightWithPadding * 2
