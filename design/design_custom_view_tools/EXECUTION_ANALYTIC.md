# Аналитик времени выполнения.

Дополнительная утилита, которую можно использовать во время разработки, чтобы произвести первичный анализ времени создания View компонентов, различных классов, времени исполнения блоков кода. Также позволяет отслеживать прогресс во время проведения работ по оптимизации, сравнивая изначальные показатели с текущими.

Полученные показатели будут иметь железо-специфичный характер, на всех девайсах показатели будут разные, поэтому вывод можно сделать только путем сравнения: создание одного класса/компонента с другим или изначальные показатели до выполненения оптимизации с финальными.
