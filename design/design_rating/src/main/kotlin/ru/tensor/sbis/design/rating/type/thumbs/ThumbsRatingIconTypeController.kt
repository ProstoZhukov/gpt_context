 ...
 * @author ps.smirnyh
 */
internal class ThumbsRatingIconTypeController(
    controller: SbisRatingViewController,
    override val iconProvider: RatingIconProvider = ThumbsRatingIconProvider(controller)
    ...
    override var maxValue: Int = SbisRatingIconType.THUMBS.emptyIcons.size
