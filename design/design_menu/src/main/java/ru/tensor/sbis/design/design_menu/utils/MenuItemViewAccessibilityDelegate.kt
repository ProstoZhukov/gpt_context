...
/**
 * Делегат для работы accessibility у [MenuItemView].
 *
 * @param host view, для которой нужна поддержка accessibility.
 * @param layoutSet набор [TextLayout], который нужно включить для accessibility.
 *
 * @author ra.geraskin
 */
internal class MenuItemViewAccessibilityDelegate(
    private val host: View,
    private var layoutSet: Set<TextLayout> = emptySet()
