...
import ru.tensor.sbis.design.sbis_text_view.contact.SbisTextViewCompoundDrawablesApi
import ru.tensor.sbis.design.sbis_text_view.contact.SbisTextViewExtensionApi
import ru.tensor.sbis.design.sbis_text_view.contact.SbisTextViewShadowApi
...
interface SbisTextViewApi :
    ...
    /**
     * Установить цвет фона подсветки.
     */
    var highlightColor: SbisColor
    ...
    @Deprecated(message = "Используй другую перегрузку")
    fun setTextWithHighlights(text: CharSequence?, highlights: TextHighlights?)

    /**
     * Установить текст с подсветкой [highlights].
     */
    fun setTextWithHighlightRanges(text: CharSequence?, positionList: List<IntRange>?)
