...
-keep public class ru.tensor.sbis.calendar.fragment.** { public protected *; }

-keep class ru.tensor.sbis.calendar.adapter.DayEventCalendarListAdapter$CalendarViewHolder { *; }
-keep class ru.tensor.sbis.calendar.adapter.ShiftsFilterAdapter$DepartmentItemHolder { *; }
-keep class ru.tensor.sbis.calendar.notification.** { *; }

-dontwarn ru.tensor.sbis.calendar.ui.schedule.department.DepartmentFilterPresenterImpl
-dontwarn ru.tensor.sbis.calendar.settings.ui.CalendarSettingsPresenter
