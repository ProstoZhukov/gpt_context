 ...
 */
interface AdvanceViewAccessSafetyApi : BaseViewAccessSafetyApi {

    /** Объект предоставляющий доступ к API [AdvanceViewAccessSafetyApi.Handler]. */
    override val viewSafetyApi: Handler

    /** Интерфейс объекта предоставляющего доступ к API [AdvanceViewAccessSafetyApi]. */
    interface Handler :
