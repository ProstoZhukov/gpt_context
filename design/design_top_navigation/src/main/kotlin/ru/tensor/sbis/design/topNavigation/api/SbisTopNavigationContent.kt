...
sealed class SbisTopNavigationContent(
    ...
    ) : SbisTopNavigationContent(measurer = largeTitleMeasurer)
    ...
    data class SmallTitle(
        ...
        val navxId: NavxIdDecl? = null,
        val onIconClicked: () -> Unit = {}
    ) : SbisTopNavigationContent(measurer = smallTitleMeasurer)
     ...
     */
    class Tabs(val tabs: LinkedList<SbisTabsViewItem>) : SbisTopNavigationContent(measurer = tabsMeasurer)
