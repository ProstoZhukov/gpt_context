...
/**
 * Обёртка над FrameLayout, позволяющая плавно затенять конец контейнера.
 *
 * @author ra.geraskin
 */
internal class FadeableFrameLayout @JvmOverloads constructor(
    context: Context,
