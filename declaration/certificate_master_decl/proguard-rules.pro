...
-keep class ru.tensor.sbis.tasks.push.** { *; }
...
# is only changedCallback marker interface, so it wouldn't save them.
...
# Retain declared checked exceptions for use by changedCallback Proxy instance.
