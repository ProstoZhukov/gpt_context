...
class PluginManagerScenario private constructor(private val scenario: () -> Unit) {
    ...
    companion object {
        fun builder(pluginManager: PluginManager = PluginManager(tracer = Tracer.fake())): ScenarioBuilder {
    ...
    private class Builder(private val pluginManager: PluginManager) : ScenarioBuilder, PreparedScenarioBuilder, TestedPreparedScenarioBuilder {
