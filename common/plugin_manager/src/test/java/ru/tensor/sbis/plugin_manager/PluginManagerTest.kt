...
import ru.tensor.sbis.plugin_manager.resolver.FlexibleFeatureResolver
...
class PluginManagerTest {
    ...
    @Test
    fun `Test configuration success when NO plugins registered`() {
    ...
    @Test
    fun `Test configuration failed when single required dependency NOT found`() {
        val plugin = Plugin0()
        PluginManagerScenario.builder()
            .prepare {
    ...
    @Test
    fun `Test configuration success when single required dependency found`() {
        val plugin0 = Plugin0()
        PluginManagerScenario.builder()
            .prepare {
    ...
    @Test
    fun `Test configuration success when single optional dependency NOT found`() {
        val plugin1 = Plugin1()
        PluginManagerScenario.builder()
            .prepare {
                registerPlugin(plugin1)
    ...
    @Test
    fun `Test configuration success when single optional dependency found`() {
        val plugin1 = Plugin1()
        PluginManagerScenario.builder()
            .prepare {
                registerPlugin(plugin1)
    ...
    @Test
    fun `Test configuration failed when required dependency set NOT found`() {
        val plugin = Plugin4()
        PluginManagerScenario.builder()
            .prepare {
                registerPlugin(plugin)
    ...
    @Test
    fun `Test configuration success when required dependency set found (single provider)`() {
        val plugin = Plugin4()
        PluginManagerScenario.builder()
            .prepare {
                registerPlugin(Plugin1())
    ...
    @Test
    fun `Test configuration success when required dependency set found (multi providers)`() {
        val plugin = Plugin4()
        PluginManagerScenario.builder()
            .prepare {
                registerPlugin(Plugin1())
    ...
    @Test
    fun `Test configuration success when optional dependency set NOT found`() {
        val plugin = Plugin5()
        PluginManagerScenario.builder()
            .prepare {
                registerPlugin(plugin)
    ...
    @Test
    fun `Test configuration success when optional dependency set found (single provider)`() {
        val plugin = Plugin5()
        PluginManagerScenario.builder()
            .prepare {
                registerPlugin(plugin)
    ...
    @Test
    fun `Test configuration success when optional dependency set found (multi providers)`() {
        val plugin = Plugin5()
        PluginManagerScenario.builder()
            .prepare {
                registerPlugin(Plugin1())
    ...
    @Test
    fun `Test configuration failed when required single dependency NOT resolved (multi providers)`() {
        val plugin = Plugin0()
        PluginManagerScenario.builder()
            .prepare {
                registerPlugin(Plugin1())
    ...
    @Test
    fun `Test configuration success when required single dependency resolved (multi providers)`() {
        val plugin0 = Plugin0()
        val plugin1 = Plugin1()
    ...
    @Test
    fun `Test configuration failed when optional single dependency NOT resolved (multi providers)`() {
        val plugin = Plugin1()
        PluginManagerScenario.builder()
            .prepare {
                registerPlugin(Plugin2())
    ...
    @Test
    fun `Test configuration success when optional single dependency resolved (multi providers)`() {
        val plugin1 = Plugin1()
        val plugin2 = Plugin2()
    ...
    @Test
    fun `Test configuration success when optional single dependency resolved - SKIPPED (multi providers)`() {
        val plugin1 = Plugin1()
        val plugin2 = Plugin2()
    ...
    @Test
    fun `Test configuration success when required multi dependency resolved (providers filtered)`() {
        val plugin0 = Plugin4()
        val plugin1 = Plugin1()
    ...
    @Test
    fun `Test configuration success when optional multi dependency resolved (providers filtered)`() {
        val plugin1 = Plugin5()
        val plugin2 = Plugin1()
    ...
    @Test
    fun `Test initialization failed when hard circular dependency found`() {
        val plugin1 = Plugin6()
        val plugin2 = Plugin7()
        PluginManagerScenario.builder()
            .prepare {
    ...
    @Test
    fun `Test initialization success when wrong initialization order`() {
        val plugin1 = Plugin6()
        val plugin2 = Plugin8()
        PluginManagerScenario.builder()
            .prepare {
    ...
    @Test
    fun `Test initialization success when monitor init problems and wrong initialization order NOT found (even)`() {
        val plugin6 = Plugin6()
        val plugin8 = Plugin8()
        val plugin9 = Plugin9()
    ...
    @Test
    fun `Test initialization success when monitor init problems and wrong initialization order NOT found (odd)`() {
        val plugin6 = Plugin6()
        val plugin8 = Plugin8()
        val plugin9 = Plugin9()
        val plugin10 = Plugin10()
    ...
    @Test
    fun `Test initialization failed when monitor init problems and wrong initialization order detected`() {
        PluginManagerScenario.builder(PluginManager(detectSlowInitProcess = true))
            .prepare {
                registerPlugin(Plugin11())
                registerPlugin(Plugin10())
