...
import ru.tensor.sbis.version_checker_decl.data.UpdateSource.APP_GALLERY
import ru.tensor.sbis.version_checker_decl.data.UpdateSource.GALAXY_STORE
import ru.tensor.sbis.version_checker_decl.data.UpdateSource.GET_APPS
import ru.tensor.sbis.version_checker_decl.data.UpdateSource.GOOGLE_PLAY_STORE
import ru.tensor.sbis.version_checker_decl.data.UpdateSource.NASH_STORE
import ru.tensor.sbis.version_checker_decl.data.UpdateSource.RU_STORE
import ru.tensor.sbis.version_checker_decl.data.UpdateSource.SBIS_MARKET
import ru.tensor.sbis.version_checker_decl.data.UpdateSource.SBIS_ONLINE
import ru.tensor.sbis.version_checker_decl.data.UpdateSource.SUNMI_STORE
import ru.tensor.sbis.version_checker_decl.data.UpdateSource.ARMAX
import ru.tensor.sbis.version_checker_decl.data.UpdateSource.TIANYU
import ru.tensor.sbis.version_checker_decl.data.UpdateSource.NEWLAND
...
internal class UpdateSourceProxy(val source: UpdateSource) {
    ...
    private fun findId(source: UpdateSource) = when (source) {
        ...
        ARMAX -> "org.ru.armax_tps570"
        TIANYU -> "com.whty.smartpos.appstore"
        NEWLAND -> "com.newland.opennl.appstore"
        SBIS_ONLINE -> ""
    }
