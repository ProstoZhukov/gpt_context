...
# ---------- Custom settings ----------
-keep, includedescriptorclasses public class ru.tensor.sbis.richtext.converter.css.style.CssStyle { *; }

-keep, includedescriptorclasses public interface ru.tensor.sbis.richtext.converter.css.CssClassSpanConverter { *; }
-keep, includedescriptorclasses public class ru.tensor.sbis.richtext.converter.css.DefaultCssClassSpanConverter { *; }
-keep, includedescriptorclasses public interface ru.tensor.sbis.richtext.converter.css.style.CssStyleSpanConverter { *; }
-keep, includedescriptorclasses public class ru.tensor.sbis.richtext.converter.css.style.DefaultCssStyleSpanConverter { *; }
