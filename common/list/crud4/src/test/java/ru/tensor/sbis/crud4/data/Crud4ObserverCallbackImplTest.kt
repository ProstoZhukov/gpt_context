...
internal class Crud4ObserverCallbackImplTest {

    private val crudObserverCallback = Crud4ObserverCallbackImpl<String, String, String>()
    private val testObserver = TestObserver<CollectionEvent<String, String, String>>()
    ...
    @Test
    fun onAddStub() {
        crudObserverCallback.onAddStub(SERVER_TROUBLE, HEADER, null)
