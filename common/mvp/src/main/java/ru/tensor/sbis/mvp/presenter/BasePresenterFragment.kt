...
/**
 * Базовых фрагмент для обслуживания логики инициализации презентера и сохранение его состояния в течении жизненного цикла Fragment
...
abstract class BasePresenterFragment<VIEW, PRESENTER : BasePresenter<VIEW>> : BaseFragment() {
    ...
    protected open val presenterKey: String? = null
    //endregion
