...
/**
 * Базовый презентер для списка с поиском и двунаправленной подгрузкой страниц
 *
 * @author am.boldinov
 * @deprecated Устаревший подход, переходим на mvi
 */
@Deprecated
@SuppressWarnings({"unused", "RedundantSuppression", "JavaDoc", "SpellCheckingInspection"})
public abstract class BaseSearchableListAbstractTwoWayPaginationPresenter
        <VIEW extends SearchableView<DataModel>, DataModel, FILTER extends ListFilter, QUERYFILTER, DATA_REFRESH_CALLBACK>
        extends BaseListAbstractTwoWayPaginationPresenter<VIEW, DataModel, FILTER, QUERYFILTER, DATA_REFRESH_CALLBACK>
     ...
     */
    protected boolean mPendingSearchRequest;
    /**
    ...
    public BaseSearchableListAbstractTwoWayPaginationPresenter(@NonNull FILTER filter,
