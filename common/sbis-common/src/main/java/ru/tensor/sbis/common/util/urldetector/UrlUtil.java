...
import ru.tensor.sbis.common.util.urldetector.detection.InputTextReader;
...
class UrlUtil {
     ...
     */
    static String removeSpecialSpaces(String urlPart) {
     ...
     */
    static String removeExtraDots(String host) {
