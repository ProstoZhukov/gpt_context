...
/**
 * Реализация сериализуемой фабрики зависимостей для компнента множественного выбора получателей
 *
 * @author vv.chekurda
 */
internal class MultiRecipientSelectionDependencyFactory(
    ...
    override fun getSelectionLoader(appContext: Context): MultiSelectionLoader<RecipientSelectorItemModel> =
        getComponent(appContext).getMultiRecipientSelectionLoader()
